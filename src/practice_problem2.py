...
def run_test_practice_problem2a():
    ...
    sequence = practice_problem2a([2, 4, 6, 12], 3)
    expected = '5, 7, 9, 15'
    actual = sequence
    print(expected)
    print(actual)

    sequence = practice_problem2a([3, 5, 7, 13], 3)
    expected = '6, 8, 10, 16'
    actual = sequence
    print(expected)
    print(actual)

    sequence = practice_problem2a([4, 6, 8, 14], 3)
    expected = '7, 9, 11, 17'
    actual = sequence
    print(expected)
    print(actual)

    sequence = practice_problem2a([5, 7, 9, 15], 3)
    expected = '8, 10, 12, 18'
    actual = sequence
    print(expected)
    print(actual)
